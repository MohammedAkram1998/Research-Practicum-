This folder contains the files needed to replicate training run 7 

This training run uses logistic regression instead of random forest in order to compare with the random forest model for algorithm selection 
